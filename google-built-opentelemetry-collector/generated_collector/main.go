...
// Program otelcol-google is an OpenTelemetry Collector binary.
package main
...
import (
	...
	googlecontrolplane "github.com/GoogleCloudPlatform/opentelemetry-operations-collector/components/google-built-opentelemetry-collector/confmap/provider/googlecontrolplane"
...
func main() {
	...
	set := otelcol.CollectorSettings{
		...
		ProviderModules: map[string]string{
			googlecontrolplane.NewFactory().Create(confmap.ProviderSettings{}).Scheme(): "github.com/GoogleCloudPlatform/opentelemetry-operations-collector/components/google-built-opentelemetry-collector/confmap/provider/googlecontrolplane v0.159.0",
